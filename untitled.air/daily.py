...
def treasure_map(count,t):
    wait(Template(r"tpl1644036685390.png", record_pos=(0.47, 0.187), resolution=(2000, 1125)),timeout=t)
...
def delivery(times,t):
    wait(Template(r"tpl1644063202341.png", record_pos=(-0.226, -0.246), resolution=(2000, 1125)),timeout=t)
    touch(Template(r"tpl1644063202341.png", record_pos=(-0.226, -0.246), resolution=(2000, 1125)))
